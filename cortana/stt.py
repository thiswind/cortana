...
def select_pyaudio_input_device(input_devices: list[Any],
                                device_index: int = 0) -> None:
    # if (device_name := os.environ.get('INPUT_DEVICE')):

    #     the_input_devices = (d for d in input_devices if device_name in d['name'] and d['defaultSampleRate'] == RATE)

    #     return the_input_devices if the_input_devices else None
    device_index = 1
